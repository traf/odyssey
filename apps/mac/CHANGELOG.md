...
- Added username search with the last profile remembered
- Added cluster sidebar with counts and a masonry grid with infinite scroll
- Added full-screen image zoom and pinch / ⌘± grid resizing
- Added Zen mode to hide all chrome
- Added trackpad haptics throughout
